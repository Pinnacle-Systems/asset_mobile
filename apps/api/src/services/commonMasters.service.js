...
export async function getBarcodeDetails(req, res, next) {
    ...
    try {
        ...
        const masterSql =
            ` SELECT J.COMPCODE COMPCODE1,A.DOCID DOCID1,A.ASSETID,C.SUBGRPNAME,A.MMADE MACHINEMADE,A.MMODEL MACHINEMODEL, E.MAINGRPNAME  MAINGRPNAME,A.REMARKS,D.RNAME RNAME1,A.ABARID,A.*
FROM GTAD A 
