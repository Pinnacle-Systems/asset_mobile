const Leave_state = {
  ...
  const leave_Meta = [
    ...
    { state: "category", id: "Leave_state", label: "Category Type", style: { full: true }, type: "select", option_data: "category_options" },
    { state: "fromDate", id: "Leave_state", label: "From Date", style: { full: false}, type: "date" },
    { state: "fltype", id: "Leave_state", label: "Fltype", style: { full: false }, type: "select", option_data: "fltype_options" },
    { state: "toDate", id: "Leave_state", label: "To Date", style: { full: false }, type: "date" },
    { state: "tltype", id: "Leave_state", label: "Tltype", style: { full: false }, type: "select", option_data: "tltype_options" },
    { state: "ltype", id: "Leave_state", label: "Leave Type", style: { full: false }, type: "select", option_data: "ltype_options" },
    { state: "totalDays", id: "Leave_state", label: "Total Days", style: { full: false }, props: { editable: false } },
    { state: "reason", id: "Leave_state", label: "Reason", style: { full: true,height:130 } },
  ];
