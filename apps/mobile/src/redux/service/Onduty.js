...
import { BASE_URL, Notifi, onduty, Permission, SUPPLIER } from "../../constants/apiUrl";
...
const OndutyRTk = createApi({
    ...
    baseQuery: fetchBaseQuery({
        baseUrl: BASE_URL,
         fetchFn: customFetchWithTimeout,
         prepareHeaders:async (headers)=>{
            await SetHeader(headers)
                  return headers
             }
    }),
    tagTypes:  ['Onduty','get_reached','get_live_user','OndutyApproval','get__vechilekm','get_all_Onduty_reason', 'OndutyHodData',"addonduty_Master","get__Date_Wise_Fuel","get__Date_Wise_Fuel_Individual"], 
    endpoints: (builder) => ({
        ondutyRequest:builder.mutation({
                    ...
                    invalidatesTags: ["onduty","get_live_user"],
                }),
               ...
               getIn: builder.query({
                            ...
                            providesTags: ['onduty'],
                                    ...
                                    providesTags: ['OndutyHodData'],
                                                  ...
                                                  invalidatesTags:  ['Onduty','get_reached', 'OndutyApproval', 'OndutyHodData','get__vechilekm']
                    ...
                    invalidatesTags: ["get_all_Onduty_reason","Onduty"],
                       }),
                         ...
                         requestOnduty_Approval:builder.mutation({
                                                  ...
                                                  invalidatesTags:  ['Onduty', 'OndutyApproval', 'OndutyHodData']
